...
module.exports = (dispatch, handlers, guide, lang) => {
	...
	function swipes_event(skillid) {
		let duration = 1;
		if ([103, 106].includes(skillid)) {
			enrage = new Date() - enrage_time >= 34500 ? false : true;
			duration = 2000;
		}
		if ([1401, 1402].includes(skillid)) {
			enrage = new Date() - enrage_time >= 34500+750 ? false : true;
			duration = 750;
		}		
		let leftSafe = [
	...
	return {
		...
		"h-3111-2000-54": [{ type: "func", func: () => is_hp_49 = true }],
		"rb-3111-2000": [
		...
		//	{ type: "text", sub_type: "message", delay: 2000, message: "1" },
			{ type: "text", sub_type: "message", delay: 3500, message_RU: "", message: "Dodge" }
		],
		"s-3111-1000-1114-0": [
